...
function fresh_lite_customize_edit_links( $wp_customize ) {
...
add_action( 'customize_register', 'fresh_lite_customize_edit_links' );
add_theme_support( 'customize-selective-refresh-widgets' );

add_action( 'admin_notices', 'fresh_lite_admin_notices' );
function fresh_lite_admin_notices()
{
	...
	?>
		<div class="notice notice-success is-dismissible">
				<b><p>Liked this theme? <a href="https://wordpress.org/support/theme/fresh-lite/reviews/#new-post" target="_blank">Leave us</a> a ***** rating. Thank you! </p></b>
		</div>
		<?php
	}
